...
class OwnerController {
	...
	public OwnerController(OwnerRepository owners, SmsService smsService) {
		this.owners = owners;
	...
	public String sendSmsToCity(@PathVariable String cityName, RedirectAttributes redirectAttributes) {
